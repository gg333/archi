...
This matrix describes Archi 0.2.0 on macOS with the bundled 7-Zip 26.02 engine. **Supported** means the operation is covered by Archi's automated compatibility corpus. **Best effort** means the bundled engine may handle the format, but Archi does not make a release guarantee for it yet.
...
| TGZ / TAR.GZ | Supported | Supported | No | No | No | No | No |
| TBZ2 / TAR.BZ2 | Supported | Supported | No | No | No | No | No |
| TXZ / TAR.XZ | Supported | Supported | No | No | No | No | No |
| GZIP stream | Supported | Supported | No | No | No | No | No |
| BZIP2 stream | Supported | Supported | No | No | No | No | No |
| XZ stream | Supported | Supported | No | No | No | No | No |
| AR | Supported | Supported | No | No | No | No | No |
| CPIO | Supported | Supported | No | No | No | No | No |
| TAR.ZST / ZSTD | Best effort | Best effort | No | Engine-dependent | No | No | No |
